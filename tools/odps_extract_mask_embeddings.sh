...
GPUS=$3
PY_ARGS=${@:4}
PY_ARGS="${PY_ARGS} --override logger.init_log_file:False --odps GIT_COMMIT_ID:\\\'$(git rev-parse --short HEAD)\\\'"
...
ENTRY_FILE=${ENTRY_FILE:-tools/odps_extract_mask_embeddings.py}
...
pai -name pytorch180
    ...
    -DworkerCount=${GPUS}
    -DuserDefinedParameters=\"${JOB_NAME} ${CONFIG} ${PY_ARGS}\"
