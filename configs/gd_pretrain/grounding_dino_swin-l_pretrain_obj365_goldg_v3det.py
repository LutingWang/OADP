...
pretrained = server_root + 'ckpt/swin_large_patch4_window12_384_22k.pth'  # noqa
num_levels = 5
model = dict(
    use_autocast=True,
...
objv2_train_pipeline = [
    ...
    dict(
        ...
        # change this
        label_map_file=server_root+'data/objects365v2/annotations/o365v2_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
...
o365v2_dataset = dict(
    type='ODVGDataset',
    data_root=server_root+'data/objects365v2/',
    ann_file='annotations/zhiyuan_objv2_train_fixname_od.json',
...
oi_train_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        # change this
        label_map_file=server_root+'data/OpenImages/annotations/openimages_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
oiv6_dataset = dict(
    type='ODVGDataset',
    data_root=server_root+'data/OpenImages/',
...
train_dataloader = dict(
    dataset=dict(datasets=[
        o365v2_dataset, flickr30k_dataset, gqa_dataset, v3det_dataset
    ]))
